...
public class Problems {
    ...
    public static boolean isNarcissistic(int number) {
        ...
        int power = numberText.toString().length();
        char[] numStringArray = numberText.toCharArray();
        int numSum = 0;

        for(char numInt : numStringArray){
            numSum += Math.pow(Integer.parseInt(String.valueOf(numInt)), power);
        }
